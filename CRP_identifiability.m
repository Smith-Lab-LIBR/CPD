function [] = CRP_identifiability(subject_id, trials, generating_model)
    ...
    for i = 1:length(outer_fit_list)
        ...
        for j = 1:length(inner_fit_list)
            ...
            DCM.model = model_handle;
             folder_name = sprintf([root 'rsmith/lab-members/rhodson/CPD/CPD_results/identifiability/%s/CRP/'], generating_model);
