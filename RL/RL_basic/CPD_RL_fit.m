...
trials = U;
L = 0;
action_probabilities = CPD_RL_model(params, trials, 0); %gener model to produce actions/outcomes; the action prob is the prob of what the model assign to the actual action that the person made. the point is to get the model to assign the highest prob to the option the person is actualy chose 
count = 0;
average_accuracy = 0;
