...
function [] = main_CRP(subject_id)
    ...
    % data_dir = "/Volumes/labs/rsmith/lab-members/nli/CPD_updated/Individual_file_mat";
     data_dir = "L:/rsmith/lab-members/nli/CPD_updated/Individual_file_mat";
    ...
    %%%%%%%%%%%%%%
    addpath('L:/rsmith/lab-members/clavalley/MATLAB/spm12/');
    addpath('L:/rsmith/lab-members/clavalley/MATLAB/spm12/toolbox/DEM/'); 
    % addpath('/Volumes/labs/rsmith/lab-members/clavalley/MATLAB/spm12/');
    % addpath('/Volumes/labs/rsmith/lab-members/clavalley/MATLAB/spm12/toolbox/DEM/'); 
    ...
    L = 0;
    action_probabilities = CPD_latent_fit(params, trials, 0); 
    count = 0;
    average_accuracy = 0;
