...
function action_probs = single_inference_max(params, trials, test, decay_type)
...
if test == 1
    ...
    %latent_learning_rate_new = 0.6;
    latent_learning_rate_new = 0.1;%params.new_latent_lr;
    ...
    for t = 1:min(trial_length, 3)
        ...
        if t == 1
            ...
            if trial_length == 1               
                ...
                % state distribution
                latent_state_rewards(max_evidence_new,:) = latent_state_rewards(max_evidence,:) +  prediction_error;
