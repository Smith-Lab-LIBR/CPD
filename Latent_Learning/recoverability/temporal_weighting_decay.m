function [latent_states_distribution, reward_probabilities, masses] = temporal_weighting_decay(decay_rate, temporal_probability_mass, reward_probabilities, forget_threshold)
